...
if __name__ == '__main__':
    ...
    month_dp = input("Which month are you leaving?")
    day_dp = input("Which day are you leaving?")
    month_arr = input("Which month are you coming back?")
    day_arr = input("Which day are you coming back?")
